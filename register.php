...
<body>
    ...
    <main class="form-signin w-100 m-auto">
        <form action="register_db.php" method="POST">
            ...
            <p class="mt-5 mb-3 text-body-secondary">Alredady have account <a href="login.php">Chick here</a> to sign in</p>
        </form>
    </main>
    ...
    <div class="container">
        ...
        <footer class="py-3 my-4">
            ...
            <p class="text-center text-body-secondary">© 2024 Loker Box</p>
        </footer>
        <!-- footer end -->
    </div>
